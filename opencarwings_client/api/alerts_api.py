...
class AlertsApi:
    ...
    def api_alerts_read(
        ...
        _param = self._api_alerts_read_serialize(
            vin=vin,
    ...
    def api_alerts_read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[AlertHistoryFull]]:
        """api_alerts_read
    ...
    def _api_alerts_read_serialize(
        self,
        vin,
        _request_auth,
        _content_type,
