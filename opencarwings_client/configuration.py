...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "Personal API Key": APIKeyAuthSetting,
...
conf = opencarwings_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://opencarwings.viaaq.eu" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("opencarwings_client")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'Personal API Key' in self.api_key:
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://opencarwings.viaaq.eu",
