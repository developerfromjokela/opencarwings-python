...
from opencarwings_client.configuration import Configuration
from opencarwings_client.api_response import ApiResponse, T as ApiResponseT
import opencarwings_client.models
from opencarwings_client import rest
from opencarwings_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(opencarwings_client.models, klass)
