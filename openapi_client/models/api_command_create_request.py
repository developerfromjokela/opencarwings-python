...
class ApiCommandCreateRequest(BaseModel):
    """
    ApiCommandCreateRequest
    """ # noqa: E501
    command_type: Union[StrictFloat, StrictInt]
    command_payload: Optional[Dict[str, Any]] = None
    command_pin: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["command_type", "command_payload", "command_pin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "command_pin": obj.get("command_pin")
        })
        return _obj
