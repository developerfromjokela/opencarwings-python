...
class AccountApi:
    ...
    def account_detail_list(
        ...
        _param = self._account_detail_list_serialize(
    ...
    def _account_detail_list_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def account_pin_create(
        ...
        _param = self._account_pin_create_serialize(
            data=data,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _account_pin_create_serialize(
        self,
        data,
        _request_auth,
        _content_type,
    ...
    def account_reset_api_key_create(
        ...
        _param = self._account_reset_api_key_create_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _account_reset_api_key_create_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/account/reset-api-key/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
