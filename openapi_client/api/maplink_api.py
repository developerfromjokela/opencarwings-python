...
class MaplinkApi:
    ...
    def api_maplink_resolve_create(
        ...
        :param data: (required)
        :type data: MapLinkResolverInput
        ...
        _param = self._api_maplink_resolve_create_serialize(
            data=data,
    ...
    def api_maplink_resolve_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MapLinkResolverResponse]:
        """api_maplink_resolve_create
    ...
    def _api_maplink_resolve_create_serialize(
        self,
        data,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/maplink/resolve',
