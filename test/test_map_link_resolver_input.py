...
class TestMapLinkResolverInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MapLinkResolverInput:
        """Test MapLinkResolverInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MapLinkResolverInput`
        """
        model = MapLinkResolverInput()
        if include_optional:
            return MapLinkResolverInput(
                url = '0'
            )
        else:
            return MapLinkResolverInput(
    ...
    def testMapLinkResolverInput(self):
        """Test MapLinkResolverInput"""
